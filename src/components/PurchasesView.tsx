      ...
      {activeView === 'create' && (
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-6 animate-fade-in" id="create-purchase-form">
          ...
          <form onSubmit={handleSavePurchaseSubmit} className="space-y-6 text-xs font-sans">
            ...
            {/* Document upload visual section split (Take photo of invoice) */}
            ...
            <div className="space-y-3">
              ...
              {purchaseItems.map((row, index) => {
                ...
                return (
                  <div key={index} className="flex flex-wrap sm:flex-nowrap gap-3 items-center bg-white p-3 border border-slate-150 rounded-xl relative">
                    {/* Item Selector */}
                    <div className="flex-1 min-w-[200px]">
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 border border-slate-205 rounded-lg p-1.5 focus:bg-white text-xs text-slate-800 outline-none"
                      >
                        {products.map(p => (
                    ...
                    <div className="w-28">
                      ...
                      <div className="flex bg-slate-50 border border-slate-205 rounded-lg items-center px-2">
                        <input
                          type="number"
                          step="any"
                          required
                          ...
                          className="w-full bg-transparent p-1 px-1 text-center font-mono font-bold"
                        />
                    ...
                    <div className="w-32">
                      ...
                      <div className="flex bg-slate-50 border border-slate-205 rounded-lg items-center px-1.5">
                    ...
                    <div className="w-24 text-right">
                      ...
                      <span className="font-mono font-bold text-sm text-slate-705 block pt-1.5 font-sans">RD${(row.qty * row.unitPrice).toLocaleString('es-DO')}</span>
                    </div>
                    ...
                    {purchaseItems.length > 1 && (
                      <button
                        ...
                        className="p-1 px-2 text-red-600 hover:bg-red-50 rounded mt-3.5"
                      >
            ...
            {/* Calculations summaries and notes */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-150">
              ...
              <div className="bg-slate-50 border border-slate-150 rounded-2xl p-5 space-y-2.5 font-sans">
                ...
                <div className="flex justify-between text-base text-slate-800 font-bold pt-1.5">
                  ...
                  <span className="font-mono text-lg text-emerald-800">RD${totals.total.toLocaleString('es-DO', { minimumFractionDigits: 2 })}</span>
                </div>
              </div>
            </div>

            <div className="p-4 border-t border-slate-150 pt-5 flex justify-end gap-2 text-xs">
              <button
                type="button"
                onClick={() => {
                  if (convertingFromRequest) {
